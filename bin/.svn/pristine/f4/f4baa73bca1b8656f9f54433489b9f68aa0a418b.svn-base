...
<html>
    <head>
        ...
        <meta name="keywords" content="Uploading Price master csv files,Upload invoice csv files,upload ndc define csv files, Assing CDM To NDC(s),Maintain Formids, Maintain Despense Factors and some other modules">
        <meta name="author" content="Info-ways">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Upload NDC-Define | Drugordering System</title>
    ...
    <body onload="sideMenu()">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="right-contentmenu">
                                ...
                                <div class="row">
                                    <div class="col-sm-8 col-sm-8 col-md-8">
                                        <label class="heading_font">Upload Formulary Extract</label>
                                    </div>
                                </div>
                                <div id="gap_30"></div>
                                <div class="row">
                                    <div class="container" id="secondsearch_row">
                                        ...
                                        <div class="col-lg-2 topclass padding-less"><label>Choose Formulary Extract File</label></div>
                                        <form:form  method="post" enctype="multipart/form-data" id="fileUploadForm">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <input type="file" accept=".csv"   class="file" id="ndcdefine" name="ndcdefine">
        ...
        $(function() {
            ...
            $("#btnSubmit").click(function(event) {
                var filelen = document.getElementById("ndcdefine").files.length;
                if (filelen == 0) {
                    ...
                    $.ajax({
                        ...
                        url: "uploadndcdefinecsv",//Controller Name is **DatamaintainenceController.java** inside (com.occularpharma.core.datamaintanence.controller)package
                        data: data,
                        processData: false,
                        contentType: false,
                        cache: false,
