...
<html>
    <head>
        ...
        <meta name="keywords" content="Uploading Price master csv files, Assing CDM To NDC(s),Maintain Formids, Maintain Despense Factors and some other modules">
        <meta name="author" content="Info-ways">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Upload Price Master | Drugordering System</title>
    ...
    <body onload="sideMenu()">
        ...
        <div id="wrapper" class="toggled">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="right-contentmenu">
                                ...
                                <div class="row">
                                    <div class="col-sm-8 col-sm-8 col-md-8">
                                        <label class="heading_font">Upload Price Master</label>
                                    </div>
                                </div>
                                <div id="gap_30"></div>
                                <div class="row">
                                    <div class="container" id="secondsearch_row">
                                        ...
                                        <div class="col-lg-2 topclass"><label>Choose Price Master File</label></div>

                                        <form:form  method="post" enctype="multipart/form-data" id="fileUploadForm">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <input type="file" accept=".csv"   class="file" id="pricemaster" name="pricemaster">
                                            ...
                                            <div class="col-lg-2"><input type="submit" class="btn uploadbutton" value="Upload File" id="btnSubmit"></div>
                                            </form:form>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-sm-12 text-center" style="display: none;text-align: left" id="exceptionprint">
                <h3 class="text-center"> <label class="text-danger">Price Master CSV File contains the following Exceptions</label></h3>
        ...
        $(function() {
            ...
            $("#btnSubmit").click(function(event) {
                var filelen = document.getElementById("pricemaster").files.length;
//                alert(filelen)
                if (filelen == 0) {
...
//                                                alert(data);
                    ...
                    $.ajax({
                        ...
                        url: "uploadpricemastercsv",//Controller Name is **DatamaintainenceController.java** inside (com.occularpharma.core.datamaintanence.controller)package
                        data: data,
                        processData: false,
                        contentType: false,
                        cache: false,
