        ...
        fSelect.prototype = {
            ...
            reload: function() {
                if (this.settings.showSearch) {
                    var search = '<div class="fs-search"><input type="search" class="searching" onblur="clearsearchfield();" placeholder="' + this.settings.searchText + '" /></div>';
...
//                            choices += '<div class="fs-option' + selected + disabled + group +  firstselectvalue + '" id="' + val + '" data-value="' + val + '" data-index="' + $this.idx + '"><input type="hidden" value="' + val + '"  name="myselectbox"/><span class="fs-checkbox"><i></i></span><div class="fs-option-label">' + $el.html() + '</div></div>';
                        ...
                        if (0 < $this.idx || '' != val || !$this.settings.multiple) {
                            ...
                            choices += '<div class="fs-option' + selected + disabled + group +  firstselectvalue + '" id="selected' + val + '" data-value="' + val + '" data-index="' + $this.idx + '"><input type="hidden" value="' + val + '"  name="myselectbox"/><span class="fs-checkbox"><i></i></span><div class="fs-option-label">' + $el.html() + '</div></div>';
