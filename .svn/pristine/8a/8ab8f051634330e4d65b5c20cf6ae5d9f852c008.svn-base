...
<html>
    <head>
        ...
        <title>Upload PO | Drugordering System</title>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="right-contentmenu">
                                ...
                                <div class="row">
                                    <div class="col-sm-8 col-sm-8 col-md-8">
                                        <label class="heading_font">Upload Purchase Order Acknowledgement</label>
                                    </div>
                                </div>
                                <div id="gap_30"></div>
                                <div class="row">
                                    ...
                                    <div class="container" id="secondsearch_row">
                                        ...
                                        <div class="col-lg-2 topclass padding-less"><label>Choose Purchase Order File</label></div>
                                        <form:form  method="post" enctype="multipart/form-data" id="fileUploadForm">
                                            <div class="col-lg-4">
                                                <div class="form-group">


                                                    <input type="file" accept=".csv"   class="file" id="purchaseorder" name="purchaseorder">
                                                    <div class="input-group col-xs-12">
                                                        <input type="text" class="form-control" id="purchasefile" disabled>
                                            ...
                                            <div class="col-lg-2"><input type="submit" value="Upload File" id="btnSubmit" class="btn uploadbutton"/></div>
                                            </form:form>
                                    </div>
                                </div>
                            </div>
...
//                alert("submit")
                var filelen = document.getElementById("purchaseorder").files.length;
                if (filelen == 0) {
...
//alert("post");
                    $.ajax({
                        ...
                        url: "uploadpurchaseordercsv",//Controller Name is **DatamaintainenceController.java** inside (com.occularpharma.core.datamaintanence.controller)package
                        data: data,
                        processData: false,
                        contentType: false,
                        cache: false,
...
//                            alert(data);
                            ...
                            var resulttext = "";
                            if(countrows[0]>0 && countrows[1]>0){
                              resulttext = countrows[0] + " records Inserted successfully " + countrows[1]+"records Updated successfully";   
                            }
