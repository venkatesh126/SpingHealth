...
//                alert("onblure")
            ...
            templates: {
                ...
                filter: '<li class="multiselect-item filter"><div class="input-group"><input class="form-control multiselect-search" type="text" style="    height: 34px;" onblur="clearsearchfield()"></div></li>',
        ...
        buildButton: function() {
            ...
            if (this.options.buttonWidth && this.options.buttonWidth !== '100%') {
                this.$button.css({
                    'width': '100%',
                    'overflow': 'hidden',
        ...
        createOptgroup: function(group) {
            if (this.options.enableCollapsibleOptGroups && this.options.multiple) {
                ...
                var r = $('<li class="multiselect-item multiselect-group"><a href="javascript:void(0);" id="selectmultiple"><input type="checkbox" name="multiselect_check" value="' + value + '"/><b> ' + label + '<b class="caret"></b></b></a></li>');
        ...
        buildSelectAll: function() {
            ...
            if (!alreadyHasSelectAll && this.options.includeSelectAllOption && this.options.multiple
                ...
                if (this.options.selectAllName) {
                    ...
                    $('label', $li).prepend('<input type="checkbox" name="multiselect_check" />');
                }
