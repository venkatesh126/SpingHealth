...
<html>
    <head>
        ...
        <meta name="keywords" content="Uploading Price master csv files,Upload invoice csv files, Assing CDM To NDC(s),Maintain Formids, Maintain Despense Factors and some other modules">
        <meta name="author" content="Info-ways">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Upload Invoice | Drugordering System</title>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="right-contentmenu">
                                ...
                                <div class="row">
                                    <div class="col-sm-8 col-sm-8 col-md-8">
                                        <label class="heading_font ">Upload Invoice Details</label>
                                    </div>
                                </div>
                                <div id="gap_30"></div>
                                <div class="row">
                                    <div class="container" id="secondsearch_row">
                                        ...
                                        <div class="col-lg-2 topclass"><label>Choose Invoice File</label></div>
                                        <div class="col-lg-4">
                                            <form:form  method="post" enctype="multipart/form-data" id="fileUploadForm">
                                                <div class="form-group">

                                                    <input type="file" accept=".csv"   name="invoice" id="invoice" class="file">
                                                    <div class="input-group col-xs-12">
                                                        <input type="text"  class="form-control" name="invoice" id="invoice" disabled >
                                            ...
                                            <div class="col-lg-2"><input type="submit" id="btnSubmit" class="btn uploadbutton" value="Upload File"></div>
                                            </form:form>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 text-center" style="display: none;text-align: left" id="exceptionprint">
                                <h3 class="text-center"> <label class="text-danger">Invoice CSV File contains the following Exceptions</label></h3>
...
//                                                    location.reload();
            ...
            $("#btnSubmit").click(function(event) {
                var filelen = document.getElementById("invoice").files.length;
                if (filelen == 0) {
                    ...
                    $.ajax({
                        ...
                        url: "uploadinvoicecsv",//Controller Name is **DatamaintainenceController.java** inside (com.occularpharma.core.datamaintanence.controller)package
                        data: data,
                        processData: false,
                        contentType: false,
                        cache: false,
